...
## The Version of this Branch is *1.21.1*. The repository attempts to provide scripts that work in all loaders without errors, by either providing scripts that work in both the same way or by using preprocessors to disable scripts when required.
