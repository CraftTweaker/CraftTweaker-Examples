...
/*
    ...
    - <tag:block:minecraft:bamboo_plantable_on> lets you change what blocks bamboo can be placed on.
    - <tag:block:minecraft:climbable> lets you mark blocks as climbable, allowing mobs to climb them like a ladder.
    - <tag:block:minecraft:enderman_holdable> lets you make a block holdable by an enderman.
    - <tag:block:minecraft:mineable/axe>, <tag:block:minecraft:mineable/hoe>, <tag:block:minecraft:mineable/pickaxe>, <tag:block:minecraft:mineable/shovel> let you make blocks mineable with different tools.
    - <tag:entity_type:minecraft:axolotl_always_hostiles> lets you make axolotl always attach an entity type.
    - <tag:item:minecraft:freeze_immune_wearables> lets you make wearing certain armor items make the player immune to freezing from powder snow.
    ...
    <tag:item:minecraft:wool>.remove(<item:minecraft:white_wool>);
    You can write:
    <tag:item:minecraft:wool>.removeId(<resource:minecraft:white_wool>);
...
// Adds Dirt to <tag:item:minecraft:planks>, allowing it to be used in place of Planks in recipes.
<tag:item:minecraft:planks>.add(<item:minecraft:dirt>);

// Adds Diamond Blocks to <tag:block:minecraft:bamboo_plantable_on>, allowing bamboo to be placed on it.
<tag:block:minecraft:bamboo_plantable_on>.add(<block:minecraft:diamond_block>);

// Adds Skeletons to <tag:entity_type:minecraft:axolotl_always_hostiles>, making Axolotl attack skeletons.
<tag:entity_type:minecraft:axolotl_always_hostiles>.add(<entitytype:minecraft:skeleton>);


// Removing from existing Tags

// Removes Leather Helmet from <tag:item:minecraft:freeze_immune_wearables>, removing it's ability to prevent freezing.
<tag:item:minecraft:freeze_immune_wearables>.add(<item:minecraft:leather_helmet>);

// Removes Diamond Blocks from <tag:block:minecraft:beacon_base_blocks>, making it that it can't be a Beacon Base.
<tag:block:minecraft:beacon_base_blocks>.remove(<block:minecraft:diamond_block>);

// Removes Rabbits from <tag:entity_type:minecraft:powder_snow_walkable_mobs>, removing their ability to walk on Powder Snow.
<tag:entity_type:minecraft:powder_snow_walkable_mobs>.remove(<entitytype:minecraft:rabbit>);
...
<tag:item:crafttweaker:pickaxe>; // Does not create the Tag.
<tag:item:crafttweaker:pickaxe>.add(<item:minecraft:diamond_pickaxe>); // Creates the Tag and adds a Diamond to it.
<tag:item:crafttweaker:pickaxe>.add(<item:minecraft:iron_pickaxe>); // Adds Iron Pickaxe to the Tag that was created by the line above.
...
for item in <tag:item:minecraft:wool> {
...
for id in <tag:item:minecraft:wool>.idElements {
...
craftingTable.addShapeless("tag_example_recipe", <item:minecraft:diamond>, [<tag:item:minecraft:logs>, <item:minecraft:dirt>, <tag:item:minecraft:rails>]);
...
// - <tag:item:crafttweaker:pickaxe>.asIIngredient()
// - <tag:item:crafttweaker:pickaxe> as IIngredient // requires an import for 'crafttweaker.api.ingredient.IIngredient'
// The script line below will add a recipe that, when crafted, will damage the given element (either a Diamond Pickaxe or an Iron Pickaxe) of the <tag:item:crafttweaker:pickaxe> tag by 2.
craftingTable.addShapeless("ingredient_tag_example_recipe", <item:minecraft:cobblestone> * 3, [<item:minecraft:cobblestone_stairs>, <tag:item:crafttweaker:pickaxe>.asIIngredient().transformDamage(2)]);
